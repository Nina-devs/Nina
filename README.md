...
The Nina project is copyrighted solely by myself, Jack G., and licensed under the most glorious and holy of all licenses ever conceived. That's right!: the RMS-blessed *GPL-3.0-only or GPL-3.0-or-later*. <sup>(Note that it is incorrect to abbreviate this to *GPL-3.0-or-later*. See [this blessed manuscript from the man Himself](https://www.gnu.org/licenses/identify-licenses-clearly.html))</sup>.
